...
class ImageTileSplitter(CommonFileDialogMixin):
    def __init__(self, parent, notebook):
        ...
        tk.Button(self.parent, text="Browse", command=lambda: self.entry_output_dir.insert(0, self.select_directory())).grid(row=3, column=2)
